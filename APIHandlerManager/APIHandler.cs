...
namespace FOIA.APIHandlerManager
{
  public class APIHandler
  {
    ...
    static string BASE_URL = "https://api.foia.gov/api/";
    static string API_KEY = "GcH58szCOPnTZuMxr7iFY9pTb0ZGdayiRay6fUfF"; //Add your API key here inside ""
    ...
    {
      string NATIONAL_PARK_API_PATH = BASE_URL + "/agency_components?limit=20";
      string parksData = "";
